...
namespace Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "mcl45678")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "mcl45678")
        {
            try
            {
